...
Page({
  ...
  onLoad: function (options) {
    ...
    var arr = []
    var sql1 = "select * from Post_Lost,User where User.OpenID=Post_Lost.OpenID and User.OpenID='" + getApp().globalData.OpenID + "'"
    var sql2 = "select * from Post_Found,User where User.OpenID=Post_Found.OpenID and User.OpenID='" + getApp().globalData.OpenID + "'"
